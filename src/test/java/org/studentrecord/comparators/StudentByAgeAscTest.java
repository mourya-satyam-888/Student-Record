...
/**
 * The type Student by age asc test.
 */
class StudentByAgeAscTest {
  ...
  void compare(ComparatorTestStructure testcase) {
    final StudentByAgeAsc studentByAgeAsc = new StudentByAgeAsc();
    final Student firstStudent = testcase.getFirstStudent();
    final Student secondStudent = testcase.getSecondStudent();
    final int actualOutput = studentByAgeAsc.compare(firstStudent, secondStudent);
