...
/**
 * The type Student by age desc test.
 */
class StudentByAgeDescTest {
  private static Stream<ComparatorTestStructure> generateCompareTest() {
    ...
    testcase1.setTestName("First less by Age than Second");
    ...
    testcase2.setTestName("Second less by Age than First");
    //Equal
  ...
  void compare(ComparatorTestStructure testcase) {
    final StudentByAgeDesc studentByAgeDesc = new StudentByAgeDesc();
    final Student firstStudent = testcase.getFirstStudent();
    final Student secondStudent = testcase.getSecondStudent();
    final int actualOutput = studentByAgeDesc.compare(firstStudent, secondStudent);
