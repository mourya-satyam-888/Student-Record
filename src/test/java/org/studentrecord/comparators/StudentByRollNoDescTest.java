...
/**
 * The type Student by roll no desc test.
 */
class StudentByRollNoDescTest {
  private static Stream<ComparatorTestStructure> generateCompareTest() {
    ...
    testcase1.setTestName("First less by RollNo than Second");
    ...
    testcase2.setTestName("Second less by RollNo than First");
    //Equal
  ...
  void compare(ComparatorTestStructure testcase) {
    final StudentByRollNoDesc studentByRollNoDesc = new StudentByRollNoDesc();
    final Student firstStudent = testcase.getFirstStudent();
    final Student secondStudent = testcase.getSecondStudent();
    final int actualOutput = studentByRollNoDesc.compare(firstStudent, secondStudent);
