...
/**
 * The type Student by name asc test.
 */
class StudentByNameAscTest {
  ...
  void compare(ComparatorTestStructure testcase) {
    final StudentByNameAsc studentByNameAsc = new StudentByNameAsc();
    final Student firstStudent = testcase.getFirstStudent();
    final Student secondStudent = testcase.getSecondStudent();
    final int actualOutput = studentByNameAsc.compare(firstStudent, secondStudent);
