...
/**
 * The type Student by roll no asc test.
 */
class StudentByRollNoAscTest {
  ...
  void compare(ComparatorTestStructure testcase) {
    final StudentByRollNoAsc studentByRollNoAsc = new StudentByRollNoAsc();
    final Student firstStudent = testcase.getFirstStudent();
    final Student secondStudent = testcase.getSecondStudent();
    final int actualOutput = studentByRollNoAsc.compare(firstStudent, secondStudent);
