...
/**
 * The type Student by address asc test.
 */
class StudentByAddressAscTest {
  ...
  void compare(ComparatorTestStructure testcase) {
    final StudentByAddressAsc studentByAddressAsc = new StudentByAddressAsc();
    final Student firstStudent = testcase.getFirstStudent();
    final Student secondStudent = testcase.getSecondStudent();
    final int actualOutput = studentByAddressAsc.compare(firstStudent, secondStudent);
