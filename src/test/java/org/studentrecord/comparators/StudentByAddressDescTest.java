...
/**
 * The type Student by address desc test.
 */
class StudentByAddressDescTest {
  ...
  private static Stream<ComparatorTestStructure> generateCompareTest() {
    ...
    Student student2 = new Student("name 2", 10,
        "address 2", "rollno 2",
        Arrays.asList(Courses.A, Courses.B, Courses.C, Courses.D));
    ...
    testcase1.setTestName("First less by address than Second");
    ...
    testcase2.setTestName("Second less by address than First");
    //Equal
  ...
  void compare(ComparatorTestStructure testcase) {
    final StudentByAddressDesc studentByAddressDesc = new StudentByAddressDesc();
    final Student firstStudent = testcase.getFirstStudent();
    final Student secondStudent = testcase.getSecondStudent();
    final int actualOutput = studentByAddressDesc.compare(firstStudent, secondStudent);
